...
export default function Button({ children, disabled, to, size, type='primary', onClick }) {
  ...
  const sizeStyle= size === 'small' ? 'px-3 py-2 text-xs sm:px-5 sm:py-2.5' : size === 'rounded' ? ' px-2.5 py-1  sm:px-3.5 sm:py-2 text-sm ' : size === 'large' ? ' lg:px-20 lg:py-9 lg:text-3xl px-4 py-3 text-base text-sm ' : size === 'medium' ?  'px-4 py-3 text-base text-sm' : 'px-4 py-3 text-base text-sm lg:px-10 lg:py-4 lg:text-xl';
