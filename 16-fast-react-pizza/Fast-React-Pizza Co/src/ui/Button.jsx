...
export default function Button({ children, disabled, to, size='medium', type='primary' }) {

  const sizeStyle= size === 'small' ? 'px-3 py-2 text-xs sm:px-5 sm:py-2.5' : 'px-4 py-3 text-base text-sm';
